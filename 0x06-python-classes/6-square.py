...
class Square:
    ...
    Attributes:
        ...
        position (tuple of int): The position of the square (x, y).
    """
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Args:
            ...
            position (tuple of int): The position of the new square (x, y).
        """
        self.size = size
    ...
    def position(self, value):
        ...
        Args:
            value (tuple of int): The new position of the square (x, y).
